...
import { BASIC_HOME_PATH, BASIC_LOGIN_PATH, PageEnum } from '@shoptop/constants'
import { router } from '@/router'
import { doLogoutApi, getUserInfoApi, doLoginApi } from '@/apis/auth'
import { PAGE_NOT_FOUND_ROUTE } from '@shoptop/router'
import { useAuthStoreWithout } from './auth'
import { GetUserInfoModel } from '@/apis/sys/user'
import { UserInfo, RoleInfo, UserState } from '@shoptop/types'
import { ErrorMessageMode } from '@shoptop/types'
import { isArray } from '@shoptop/utils'
